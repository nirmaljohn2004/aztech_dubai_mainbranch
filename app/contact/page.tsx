          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12 py-16 md:py-24">
            ...
            <div className="grid grid-cols-12 gap-6 border-b border-[var(--canvas-border)] pb-12 mb-16">
              ...
              <div className="col-span-12 md:col-span-8 lg:col-span-9">
                <h1 className="font-serif text-[7vw] md:text-[6vw] font-medium tracking-[-0.04em] leading-[0.95] text-white">
            ...
            <div className="grid grid-cols-12 gap-8 lg:gap-16 items-start">
              ...
              {/* Left Column: Directories & Hotlines (Span 5) */}
              ...
              {/* Right Column: Inquiry Form with float label underline inputs (Span 7) */}
              <div className="col-span-12 lg:col-span-7">
                {isSubmitted ? (
                  <div className="flex flex-col items-start py-12">
                    ...
                    <h3 className="font-serif text-2xl font-medium tracking-tight mb-4 text-white">
                      Request Initiated.
                    </h3>
                    ...
                    <a 
                      href="/#projects" 
                      className="inline-flex items-center gap-2 font-mono text-[10px] tracking-widest uppercase text-purple-400 hover:text-purple-300"
                    >
                  ...
                  <form ref={formRef} onSubmit={handleSubmit} className="space-y-10" noValidate>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8">
                      ...
                      <div className="relative flex flex-col pt-4">
                        <input
                          ...
                          className="bg-transparent border-b border-white/20 focus:border-purple-500 text-sm py-2 px-0 focus:outline-none transition-colors rounded-none w-full text-white"
                        />
                        <label 
                          htmlFor="name" 
                      ...
                      <div className="relative flex flex-col pt-4">
                        <select
                          ...
                          className="bg-transparent border-b border-white/20 focus:border-purple-500 text-sm py-2 px-0 focus:outline-none transition-colors rounded-none appearance-none cursor-pointer w-full text-white"
                        >
                    ...
                    <div className="relative flex flex-col pt-6">
                      <textarea
                        ...
                        className="bg-transparent border-b border-white/20 focus:border-purple-500 text-sm py-2 px-0 focus:outline-none transition-colors resize-none rounded-none w-full text-white"
                      />
                      <label 
                        htmlFor="message" 
                        className={`absolute left-0 transition-all duration-300 origin-left pointer-events-none font-mono uppercase tracking-wider
